...
[_FN] = LAYOUT(
  CT_MAKE, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX, KC_INS,
  XXXXXXX, KC_HOME, KC_UP,   KC_END,  KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ___T___,
  ___T___, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CT_JIGG,
  ___T___, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ___T___, XXXXXXX,
  XXXXXXX, ___T___, ___T___,                            ___T___,                            ___T___, XXXXXXX, ___T___, XXXXXXX),
...
[_LW] = LAYOUT(
  ...
  ___T___, KC_MPRV, KC_VOLD, KC_MNXT, KC_PGDN, CT_GAME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CT_JIGG,
  ___T___, XXXXXXX, KC_MUTE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ___T___, XXXXXXX,
  XXXXXXX, ___T___, ___T___,                            ___T___,                            ___T___, XXXXXXX, ___T___, XXXXXXX),
...
[_GF] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX,                            ___T___,                            XXXXXXX, XXXXXXX, ___T___, XXXXXXX)
};
